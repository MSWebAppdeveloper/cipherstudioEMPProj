    ...
    const checkAttendanceStatus = async () => {
      try {
        ...
        const response = await axios.get(
          "http://192.168.1.12:8082/api/employee/attendance/status",
  ...
  const handleSignIn = async () => {
    try {
      ...
      const response = await axios.post(
        "http://192.168.1.12:8082/api/employee/attendance/signin",
        {
  ...
  const handleSignOut = async () => {
    try {
      ...
      const response = await axios.put(
        `http://192.168.1.12:8082/api/employee/attendance/signout/${attendanceId}`,
        {
