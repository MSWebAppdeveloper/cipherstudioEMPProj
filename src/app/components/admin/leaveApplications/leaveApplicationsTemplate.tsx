                        ...
                        <td className="p-2 whitespace-nowrap">
                          {leave.status === "pending" && (
                            <div className="justify-center flex">
                              <div>
                                <button
                                  className="rounded-full w-10 h-10 bg-green-500 text-white text-md hover:bg-green-600 shadow-xl mr-3"
                              ...
                              <div>
                                <button
                                  className="rounded-full w-10 h-10 bg-red-500 text-white text-md hover:bg-red-600 shadow-xl"
