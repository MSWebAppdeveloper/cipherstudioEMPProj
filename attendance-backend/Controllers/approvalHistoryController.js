  ...
  createApprovalHistory: async (req, res) => {
    try {
      ...
      const emailContentToUser = `
        ...
        <p>To view your leave history, go to your portal and view "Leave Request" section or <a href="http://192.168.1.8/employee/leaveRequest">Click Here</a>.</p>
      `;
      ...
      const emailContentToManagement = `
        ...
        <p>Check all Leave Applications, go to your portal and view "Leaves" section or <a href="http://192.168.1.8/admin/leaveApplications">Click Here</a>.</p>
      `;
