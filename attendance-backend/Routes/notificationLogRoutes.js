...
router.get(
  ...
  notificationLogController.getAllNotificationLogs
);

// Get Notification Log By ID
router.get(
  "/notificationLog/getById/:id",
  notificationLogController.getNotificationLogById
);

// Update Notification Log
router.put(
  "/notificationLog/update/:id",
  notificationLogController.updateNotificationLog
);

// Delete Notification Log
router.delete(
  "/notificationLog/delete/:id",
