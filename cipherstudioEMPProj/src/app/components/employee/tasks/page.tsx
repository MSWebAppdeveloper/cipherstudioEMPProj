...
const TaskComponent: React.FC = () => {
  ...
  //     try {
  //       const response = await fetch(`http://192.168.1.8:8080/api/tasks/${selectedTaskId}/history`);
  ...
  const fetchTaskHistory = async (page: number) => {
    try {
      ...
      const response = await fetch(
        `http://192.168.1.8:8080/api/tasks/${UserId}?userName=${userName}&page=${page}&limit=${formdata.limit}&sortColumn=${sortColumn}&sortOrder=${sortOrder}&status=${filterValue}`,
        {
          method: "GET",
          headers: {
  ...
  const startTask = async (taskId: any) => {
    try {
      const response = await fetch(`http://192.168.1.8:8080/api/tasks/${taskId}/start`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const endTask = async (taskId: any) => {
    try {
      const response = await fetch(`http://192.168.1.8:8080/api/tasks/${taskId}/end`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  //   try {
  //     const response = await fetch(`http://192.168.1.8:8080/api/tasks/${taskId}/hold`, {
  //       method: 'PUT',
  //       headers: {
  //         'Content-Type': 'application/json',
  //       },
  ...
  const resumeTask = async (taskId: any) => {
    try {
      const response = await fetch(`http://192.168.1.8:8080/api/tasks/${taskId}/resume`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
